...
export const api = {
  ...
  classifyAdult: (ids: string[]) => req<{ scanned: number; adult: number; non_adult: number; unclear: number; results: any[] }>(`${B}/domains/classify-adult`, J({ domain_ids: ids })),
